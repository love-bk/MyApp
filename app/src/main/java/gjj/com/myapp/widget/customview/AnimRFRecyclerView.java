package gjj.com.myapp.widget.customview;
...
import gjj.com.myapp.widget.customview.listener.OverScrollListener;
import gjj.com.myapp.widget.customview.manager.AnimRFLinearLayoutManager;
...
public class AnimRFRecyclerView extends RecyclerView implements Runnable {
    ...
    public void addHeaderView(View view) {
        ...
        if (mAdapter != null) {
            if (!(mAdapter instanceof WrapAdapter)) {
                mAdapter = new WrapAdapter(mHeaderViews, mAdapter);
            }
        }
    }
     ...
     * 设置刷新和加载更多数据的监听
     *
     * @param listener {@link gjj.com.myapp.widget.customview.AnimRFRecyclerView.LoadDataListener}
     */
    ...
    public void setAdapter(Adapter adapter) {
        ...
        // 使用包装了头部和脚部的适配器
        adapter = new WrapAdapter(mHeaderViews, adapter);
    ...
    private class WrapAdapter extends Adapter<ViewHolder> {
        ...
        public WrapAdapter(ArrayList<View> mHeaderViews, Adapter mAdapter) {
